...
function UserAuth(){
    ...
    return (
        <section className="fixed z-50 top-0 left-0 right-0 bottom-0 bg-black/70 flex items-center justify-center">
            <div className="w-4/5 sm:w-1/2 lg:w-1/3 xl:w-1/4 bg-white px-6 sm:px-8 md:px-10 rounded-md drop-shadow-xl drop-shadow-blue-300 relative flex overflow-hidden">
                ...
                <FontAwesomeIcon icon={faClose} className="absolute top-5 right-5 cursor-pointer" />
