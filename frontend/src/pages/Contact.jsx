...
function Contact() {
    ...
    return (
        <Container className="body-font mt-24 lg:mt-32">
            <form onSubmit={handleSubmit(submitMessageForm)} className="flex flex-col items-center text-sm border-2 border-blue-100 sm:w-3/5 xl:w-2/5 py-8 lg:py-10 rounded-lg shadow-md mx-auto">
                <p className="text-xs mb-2 bg-indigo-200 text-blue-500 font-medium px-3 py-1 rounded-full">Contact Us</p>
                <Heading className="text-4xl font-bold text-center" heading="Let’s Get In Touch." />
                <p className="max-md:text-sm mt-2 text-gray-600 pb-10 text-center">
                    Or just reach out manually to us at <a href="#" className="text-blue-500 hover:underline">team@instastay.com</a>
                </p>

                <div className="sm:max-w-4/5 w-full px-4">
                    <label htmlFor="name" className="font-medium">Full Name</label>
                    <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-blue-500 transition-all overflow-hidden">
                        ...
                        <input type="text" className="h-full px-2 w-full outline-none bg-transparent" placeholder="Enter your full name" {...register('name', {required:true})} />
                    </div>
                    ...
                    <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-blue-500 transition-all overflow-hidden">
                        ...
                        <input type="email" className="h-full px-2 w-full outline-none bg-transparent" placeholder="Enter your email address" {...register('email', {required:true})} />
                    </div>
